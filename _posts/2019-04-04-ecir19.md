...
- collect relevant conversational data and ensure its <b>quality</b> (sample and preprocess) for training a dialogue system;
- detect <b>failures</b> in conversations from the system transcript logs to further improve the dialogue system.


<h3>Conversation Mining -- Process Mining from Conversation Transcripts</h3>
