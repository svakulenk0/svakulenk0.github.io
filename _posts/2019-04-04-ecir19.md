...
We analysed four dataset of information-seeking dialogues across different domains and extracted a general model using our QRFA annotation schema.
...
For more details on the approach we used to extract the process model from conversational transcript and the model evaluation in terms of fitness, generalisation ability and dialogue break-down detection <a href="https://arxiv.org/pdf/1812.10720.pdf" target="_blank">read our article</a> accepted to ECIR 2019 as a full research paper.
